...
public class FacadeWandItem extends Item {
    ...
    public void appendHoverText(@Nonnull ItemStack stack, @Nonnull TooltipContext context, @Nonnull List<Component> tooltipComponents, @Nonnull TooltipFlag tooltipFlag) {
        tooltipComponents.add(Component.translatable("tooltip.landsutilities.facade_wand").withStyle(ChatFormatting.AQUA));
        var facade = stack.get(LandsUtilities.CURRENT_FACADE);
        if (facade != null) {
            tooltipComponents.add(Component.translatable("tooltip.landsutilities.facade_wand.current_facade", facade.toString()).withStyle(ChatFormatting.YELLOW));
        }
    }
